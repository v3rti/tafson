...
export default function Musicbar(){
  return(
    <div className=" flex flex-row items-center justify-between	 gap-36 absolute px-20 w-full bg-primary-green h-16 bottom-0">
      <div className="flex flex-row items-center text-white gap-2 ">
        ...
        <div><MdOutlinePause className="w-6 h-6 text-white" /></div>
      ...
      <div className="text-white flex flex-row items-center">
          ...
          <div><IoMdHeart className="ml-8 w-6 h-6"/></div>
      </div>
    </div>
  )
}